...
public class Global extends GlobalSettings {
    ...
    public void onStart(final Application app) {
		...
		JPA.withTransaction(() -> {
			userDao.create(new Users("danielgoncalvesti@gmail.com", "123", "Daniel Goncalves da Silva"));
			Logger.info("The user: danielgoncalvesti@gmail.com was saved successfully!");
			userDao.create(new Users("robson@naturejardim.com.br", "123", "Robson Lazaretti"));
